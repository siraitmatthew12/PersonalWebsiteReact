        ...
        <>
            <nav className="navbar">
                <div className="navbar-container">
                    <a href="App.js"><Link to="App.js" className="navbar-logo" onClick={closeMobileMenu}>
                    ...
                    <ul className={click ? 'nav-menu active':'nav-menu'} id='horizontal-list'>
                        <li className="nav-item">
                            <a href="App.js"><Link to='App.js' className='nav-links' onClick={closeMobileMenu}>
                                Home
                            </Link></a>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item">
                            ...
                            <li className="nav-item"><a href="Contact.js"><Link to='Contact.js' className='nav-links' onClick={closeMobileMenu}>
                                Contact 
                            </Link></a>
                        </li>
                    </ul>
